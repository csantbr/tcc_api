...
from apps.submissions.crud import create, delete, get
...
@submission_router.post('/submissions', summary='Send a new submission', status_code=status.HTTP_201_CREATED, response_model=SubmissionOut, tags=['submissions'])
